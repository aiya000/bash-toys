...
[[ -z $BASH_TOYS_MUSIC_PLAYER_OPTIONS ]] && export BASH_TOYS_MUSIC_PLAYER_OPTIONS='--gain=0.3'
...
[[ -z $BASH_TOYS_POMODORO_RESUME_HISTORY_SIZE ]] && export BASH_TOYS_POMODORO_RESUME_HISTORY_SIZE=10
