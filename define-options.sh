...
[[ -z $BASH_TOYS_KILL_LISTED_PROCESS_NAMES ]] && export BASH_TOYS_KILL_LISTED_PROCESS_NAMES='nvim claude java npm node deno'
[[ -z $BASH_TOYS_KILL_LISTED_APPS ]] && export BASH_TOYS_KILL_LISTED_APPS='OpenDeck'
