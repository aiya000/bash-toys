...
[[ -z $BASH_TOYS_TMP_BASE_DIR ]] && export BASH_TOYS_TMP_BASE_DIR= # A base directory for temporary directories possible to use large files (because, maybe, should not be `/tmp`)
