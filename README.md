...
| [`docker-tool`](./bin/docker-tool) | Docker utilities (attach/kill via menu, teardown compose, prune containers/volumes) | `$ docker-tool teardown-compose clean-volumes # run multiple` | [![Test](https://github.com/aiya000/bash-toys/actions/workflows/test-docker-tool.yml/badge.svg)](https://github.com/aiya000/bash-toys/actions/workflows/test-docker-tool.yml) |
...
| [`free-macos`](./bin/free-macos) | Show system-wide memory usage on macOS, filling in for Linux' `free` | `$ free-macos --detail # total/used/available` | [![Test](https://github.com/aiya000/bash-toys/actions/workflows/test-free-macos.yml/badge.svg)](https://github.com/aiya000/bash-toys/actions/workflows/test-free-macos.yml) |
...
| [`git-bridge-wsl-and-windows`](./bin/git-bridge-wsl-and-windows) | Bridges WSL2 git and Windows git.exe for performance on Windows-mounted paths | `$ git-bridge-wsl-and-windows status # bridged status` | [![Test](https://github.com/aiya000/bash-toys/actions/workflows/test-git-bridge-wsl-and-windows.yml/badge.svg)](https://github.com/aiya000/bash-toys/actions/workflows/test-git-bridge-wsl-and-windows.yml) |
...
| [`is-in-windows-path`](./bin/is-in-windows-path) | Check if the current directory is on a Windows-mounted path (WSL) | `$ is-in-windows-path && echo Windows # detect` | [![Test](https://github.com/aiya000/bash-toys/actions/workflows/test-is-in-windows-path.yml/badge.svg)](https://github.com/aiya000/bash-toys/actions/workflows/test-is-in-windows-path.yml) |
...
| [`kill-listed-processes`](./bin/kill-listed-processes) | Kill processes and macOS apps listed in environment variables | `$ kill-listed-processes # kill preset list` | [![Test](https://github.com/aiya000/bash-toys/actions/workflows/test-kill-listed-processes.yml/badge.svg)](https://github.com/aiya000/bash-toys/actions/workflows/test-kill-listed-processes.yml) |
| [`mklink-wsl`](./bin/mklink-wsl) | Create a Windows symlink from WSL via cmd.exe | `$ mklink-wsl MyLink C:\Target # junction` | [![Test](https://github.com/aiya000/bash-toys/actions/workflows/test-mklink-wsl.yml/badge.svg)](https://github.com/aiya000/bash-toys/actions/workflows/test-mklink-wsl.yml) |
...
| [`ps-mem`](./bin/ps-mem) | Display per-process memory usage in a readable table (wraps smem on Linux, ps and top on macOS) | `$ ps-mem --footprint --total # macOS` | [![Test](https://github.com/aiya000/bash-toys/actions/workflows/test-ps-mem.yml/badge.svg)](https://github.com/aiya000/bash-toys/actions/workflows/test-ps-mem.yml) |
...
| [`grep-skip-self`](./sources/grep-skip-self.sh) | Run grep in a pipe and auto-exclude its own process line from results | `$ ps aux \| grep-skip-self nginx` | [![Test](https://github.com/aiya000/bash-toys/actions/workflows/test-grep-skip-self.yml/badge.svg)](https://github.com/aiya000/bash-toys/actions/workflows/test-grep-skip-self.yml) |
...
| [`rg-skip-self`](./sources/rg-skip-self.sh) | Run rg in a pipe and auto-exclude its own process line from results | `$ ps aux \| rg-skip-self nginx` | [![Test](https://github.com/aiya000/bash-toys/actions/workflows/test-rg-skip-self.yml/badge.svg)](https://github.com/aiya000/bash-toys/actions/workflows/test-rg-skip-self.yml) |
