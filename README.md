...
| [`define-alt`](./sources/define-alt.sh) | Defines a shell variable named 'foo' if not defined; use `--export` to also export | `$ define-alt EDITOR vim # set if unset` | ![No Test](https://img.shields.io/badge/Test-N%2FA-lightgray) |
