...
| [`set-audio-volume`](./bin/set-audio-volume) | Adjust audio volume to match a target mean/max level using ffmpeg | `$ set-audio-volume --input foo.mp3 --output bar.mp3 --mean-volume -48.7` | [![Test](https://github.com/aiya000/bash-toys/actions/workflows/test-set-audio-volume.yml/badge.svg)](https://github.com/aiya000/bash-toys/actions/workflows/test-set-audio-volume.yml) |
