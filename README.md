...
| [`is-in-macos`](./bin/is-in-macos) | Check if current shell is running on macOS | `$ is-in-macos && echo macOS # detect macOS` | [![Test](https://github.com/aiya000/bash-toys/actions/workflows/test-is-in-macos.yml/badge.svg)](https://github.com/aiya000/bash-toys/actions/workflows/test-is-in-macos.yml) |
