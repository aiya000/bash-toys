...
| [`ps-mem`](./bin/ps-mem) | Display per-process memory usage in a readable table (wraps smem on Linux, ps on macOS) | `$ ps-mem --swap --rss # SWAP then RSS` | [![Test](https://github.com/aiya000/bash-toys/actions/workflows/test-ps-mem.yml/badge.svg)](https://github.com/aiya000/bash-toys/actions/workflows/test-ps-mem.yml) |
