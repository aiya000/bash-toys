...
| [`docker-tool`](./bin/docker-tool) | Docker utilities (attach/kill via menu, teardown compose, prune containers/volumes) | `$ docker-tool remove-all # clean all` | [![Test](https://github.com/aiya000/bash-toys/actions/workflows/test-docker-tool.yml/badge.svg)](https://github.com/aiya000/bash-toys/actions/workflows/test-docker-tool.yml) |
