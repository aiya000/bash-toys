...
| [`docker-fix`](./bin/docker-fix) | Docker maintenance utilities (teardown compose, prune containers/volumes) | `$ docker-fix remove-all # clean all` | [![Test](https://github.com/aiya000/bash-toys/actions/workflows/test-docker-fix.yml/badge.svg)](https://github.com/aiya000/bash-toys/actions/workflows/test-docker-fix.yml) |
