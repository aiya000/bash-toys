...
| [`set-audio-volume`](./bin/set-audio-volume) | Adjust audio volume to match a target mean/max level using ffmpeg | `$ set-audio-volume --input foo.mp3 --output bar.mp3 --mean-volume -48.7` | ![No Test](https://img.shields.io/badge/Test-N%2FA-lightgray) |
